  ...
  return (
    ...
    >
      ...
      >
        ...
        <button className="p-2 bg-yellow-500 text-white rounded-full hover:bg-yellow-600 transition-colors">
          <FaPlus />
        </button>
      </div>
      <div className="p-2">
            ...
            <div className="ml-3 flex-1">
              ...
              <div className="flex justify-center items-baseline">
                ...
                {contact?.conversation && contact?.conversation?.unreadCount > 0 && contact?.conversation?.lastMessage?.receiver === user?._id && (
                  <p className={`text-sm font-semibold w-6 h-6 flex items-center bg-yellow-500 ${theme === "dark" ? "text-gray-800" : "text-gray-500"} rounded-full`}>
