...
import { TbArrowLeft, TbMessage2Heart, TbPlus, TbUser } from "react-icons/tb";
    ...
    try {
      ...
      if (email) {
        ...
        if (response.status === "success") {
          toast.info("OTP is sent to your email successfully");
        ...
        if (response.status === "success") {
          toast.info("OTP is sent to your phonenumber successfully");
          setUserPhoneData({
            phoneNumber,
    ...
    try {
      ...
      if (response.status === "success") {
        ...
        if (user?.username && user?.profilePicture) {
          setUser(user);
          toast.success("Welcome back to Quickit");
          navigate("/");
          resetLoginState();
        } else {
          setStep(3);
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <TbMessage2Heart className="w-16 h-16 text-white" />
        </motion.div>
                        ...
                        <input
                          ...
                          className={`w-full px-2 py-1 border ${
                            theme === "dark"
                              ...
                              : "bg-white border-gray-300"
                          } rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-yellow-500`}
                        />
                      </div>
                ...
                <input
                  ...
                  className={`w-2/3 px-4 py-2 border ${
                    theme === "dark"
                      ...
                      : "bg-white border-gray-300"
                  } rounded-md focus:outline-none focus:right-2 focus:ring-yellow-500 ${
        ...
        {step === 3 && (
          ...
          >
            <div className="flex flex-col items-center mb-4">
              <div className="relative w-24 h-24 mb-2">
                ...
                <label
                  ...
                  className="absolute bottom-0 right-0 bg-yellow-500 text-white p-2 rounded-full cursor-pointer hover:bg-yellow-600 transition duration-300"
                >
                ...
                {avatars.map((avatar, index) => (
                  <img
                    ...
                    className={`w-12 h-12 rounded-full cursor-pointer transition duration-300 ease-in-out transform hover:scale-110 ${
                      selectedAvatar === avatar ? "ring-2 ring-yellow-500" : ""
                    }`}
              ...
              <input
                ...
                className={`w-full pl-10 pr-3 py-2 border ${
                  theme === "dark"
                    ? "bg-gray-700 border-gray-600 text-white"
                    : "bg-white border-gray-300"
                } rounded-md focus:outline-none focus:ring-2 focus:ring-yellow-500 text-lg`}
              />
            ...
            <button
              ...
              className={`w-full bg-yellow-500 text-white font-bold py-3 px-4 rounded-md transition duration-300 ease-in-out transform hover:scale-105 flex items-center justify-center text-lg ${
